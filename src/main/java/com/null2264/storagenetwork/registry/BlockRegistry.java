...
public class BlockRegistry {
    ...
    public static void register(){
        ...
        Registry.register(Registry.BLOCK, new Identifier(MODID, "master_block"), MASTER_BLOCK);
        ...
        Registry.register(Registry.ITEM, new Identifier(MODID, "master_block"), new BlockItem(MASTER_BLOCK, new FabricItemSettings().group(ItemGroup.MISC)));
    }
}
